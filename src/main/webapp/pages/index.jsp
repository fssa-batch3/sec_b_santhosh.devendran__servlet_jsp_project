...
<body >
	...
	<a href="/aviease-web/admin/list_all_user"><button class="adminbn">admin</button></a>
...
function showSucess(message, duration) {
    ...
    setTimeout(() => {
    	...
    	sucessMessage.classList.add('hide');

        setTimeout(() => {
        	sucessMessage.style.display = 'none';
        	sucessMessage.classList.remove('hide');
        }, 500); 
    }, duration);
}
...
<div class="sucess" id="sucess-message"></div>
	...
	<%
	String smessage = (String) request.getAttribute("sucessMessage");
	if (message != null) {
		request.removeAttribute("sucessMessage");

	%>
	<script>
        showSucess("<%=smessage%>", 2000);
	</script>
	<%
	}
	%>
