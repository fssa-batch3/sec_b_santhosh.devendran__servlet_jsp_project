...
%>
    ...
    <section class="section over seatsec">
        ...
        <div class="flightbody" id="flightBody">
            ...
            <div>
                <button class="seat ex" >1A</button><span>Available</span><button class="seat booked ex" >1A</button><span>Booked</span><button class="seat selected ex" >1A</button><span>selected</span>
            </div>
