...
%>
  <table>
        ...
        <tr>
            ...
            <a href="booking/new?flightId=<%=flight.getId()%>&date=<%=date%>"><button style="background-color: #007bff; color: #fff;"> Book now</button></a>
            <%}else if(alreadyBooked){ %>
            <button style="background-color: #ccc; color: #333;"> already booked</button>
           	<%}else{ %>
            <button style="background-color: #ccc; color: #333;"> closed</button>
           <%} %>
