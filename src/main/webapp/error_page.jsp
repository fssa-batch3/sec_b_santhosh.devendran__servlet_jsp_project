...
/* Error Page */
 ...
 .error {
    ...
    {
        width: 150px;   /*Contrall play with javascript*/ 
    }
...
<body>
        ...
        <!-- Error Page -->
            <div class="error center">
                <div class="container-floud">
                 ...
                 <h3 class="back" id="clickBack">click here to go back... </h3>
            </div>
        ...
        String link="";      	
        link=logged==true?"/flight/search":"/user/login";
        	%>
        ...
        document.getElementById("clickBack").addEventListener("click", function () {
            window.location.href = "<%= request.getContextPath() + link %>";
        });
